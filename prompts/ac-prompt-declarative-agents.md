...
Source: awesome-copilot/prompts/declarative-agents.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-declarative-agents.
