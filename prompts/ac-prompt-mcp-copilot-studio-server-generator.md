# ac-prompt-mcp-copilot-studio-server-generator
...
Source: awesome-copilot/prompts/mcp-copilot-studio-server-generator.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-mcp-copilot-studio-server-generator.
