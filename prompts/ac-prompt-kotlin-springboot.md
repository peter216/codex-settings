# ac-prompt-kotlin-springboot

Description: Get best practices for developing applications with Spring Boot and Kotlin.
Source: awesome-copilot/prompts/kotlin-springboot.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-kotlin-springboot.
