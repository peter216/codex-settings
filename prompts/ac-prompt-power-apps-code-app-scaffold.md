# ac-prompt-power-apps-code-app-scaffold
...
Source: awesome-copilot/prompts/power-apps-code-app-scaffold.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-power-apps-code-app-scaffold.
