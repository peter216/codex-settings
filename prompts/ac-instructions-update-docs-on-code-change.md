# ac-instructions-update-docs-on-code-change
...
Applies to: **/*.{md,js,mjs,cjs,ts,tsx,jsx,py,java,cs,go,rb,php,rs,cpp,c,h,hpp}
Source: awesome-copilot/instructions/update-docs-on-code-change.instructions.md
