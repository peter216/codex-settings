# ac-prompt-containerize-aspnet-framework
...
Source: awesome-copilot/prompts/containerize-aspnet-framework.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-containerize-aspnet-framework.
