# ac-instructions-pcf-best-practices

Description: Best practices and guidance for developing PCF code components
Applies to: **/*.{ts,tsx,js,json,xml,pcfproj,csproj,css,html}
Source: awesome-copilot/instructions/pcf-best-practices.instructions.md
