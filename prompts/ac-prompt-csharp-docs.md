# ac-prompt-csharp-docs

Description: Ensure that C# types are documented with XML comments and follow best practices for documentation.
Source: awesome-copilot/prompts/csharp-docs.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-csharp-docs.
