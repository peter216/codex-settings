# ac-prompt-power-bi-dax-optimization
...
Source: awesome-copilot/prompts/power-bi-dax-optimization.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-power-bi-dax-optimization.
