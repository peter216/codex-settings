# ac-prompt-java-refactoring-extract-method

Description: Refactoring using Extract Methods in Java Language
Source: awesome-copilot/prompts/java-refactoring-extract-method.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-java-refactoring-extract-method.
