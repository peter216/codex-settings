# ac-prompt-model-recommendation
...
Source: awesome-copilot/prompts/model-recommendation.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-model-recommendation.
