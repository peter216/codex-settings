# ac-prompt-create-github-action-workflow-specification

Description: Create a formal specification for an existing GitHub Actions CI/CD workflow, optimized for AI consumption and workflow maintenance.
Source: awesome-copilot/prompts/create-github-action-workflow-specification.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-create-github-action-workflow-specification.
