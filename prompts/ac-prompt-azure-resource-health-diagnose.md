# ac-prompt-azure-resource-health-diagnose

Description: Analyze Azure resource health, diagnose issues from logs and telemetry, and create a remediation plan for identified problems.
Source: awesome-copilot/prompts/azure-resource-health-diagnose.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-azure-resource-health-diagnose.
