# ac-instructions-declarative-agents-microsoft365
...
Applies to: **.json, **.ts, **.tsp, **manifest.json, **agent.json, **declarative-agent.json
Source: awesome-copilot/instructions/declarative-agents-microsoft365.instructions.md
