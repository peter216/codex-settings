# ac-instructions-azure-logic-apps-power-automate
...
Applies to: **/*.json,**/*.logicapp.json,**/workflow.json,**/*-definition.json,**/*.flow.json
Source: awesome-copilot/instructions/azure-logic-apps-power-automate.instructions.md
