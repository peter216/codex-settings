# ac-prompt-pytest-coverage

Description: Run pytest tests with coverage, discover lines missing coverage, and increase coverage to 100%.
Source: awesome-copilot/prompts/pytest-coverage.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-pytest-coverage.
