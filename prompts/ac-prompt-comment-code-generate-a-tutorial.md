# ac-prompt-comment-code-generate-a-tutorial

Description: Transform this Python script into a polished, beginner-friendly project by refactoring the code, adding clear instructional comments, and generating a complete markdown tutorial.
Source: awesome-copilot/prompts/comment-code-generate-a-tutorial.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-comment-code-generate-a-tutorial.
