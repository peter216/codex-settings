# ac-prompt-create-agentsmd

Description: Prompt for generating an AGENTS.md file for a repository
Source: awesome-copilot/prompts/create-agentsmd.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-create-agentsmd.
