# ac-prompt-java-refactoring-remove-parameter

Description: Refactoring using Remove Parameter in Java Language
Source: awesome-copilot/prompts/java-refactoring-remove-parameter.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-java-refactoring-remove-parameter.
