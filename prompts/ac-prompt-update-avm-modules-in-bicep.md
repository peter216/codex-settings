# ac-prompt-update-avm-modules-in-bicep

Description: Update Azure Verified Modules (AVM) to latest versions in Bicep files.
Source: awesome-copilot/prompts/update-avm-modules-in-bicep.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-update-avm-modules-in-bicep.
