# ac-prompt-breakdown-epic-arch

Description: Prompt for creating the high-level technical architecture for an Epic, based on a Product Requirements Document.
Source: awesome-copilot/prompts/breakdown-epic-arch.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-breakdown-epic-arch.
