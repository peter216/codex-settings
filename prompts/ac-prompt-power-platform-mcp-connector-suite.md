# ac-prompt-power-platform-mcp-connector-suite
...
Source: awesome-copilot/prompts/power-platform-mcp-connector-suite.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-power-platform-mcp-connector-suite.
