# ac-prompt-csharp-tunit

Description: Get best practices for TUnit unit testing, including data-driven tests
Source: awesome-copilot/prompts/csharp-tunit.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-csharp-tunit.
