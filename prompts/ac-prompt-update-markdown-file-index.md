# ac-prompt-update-markdown-file-index

Description: Update a markdown file section with an index/table of files from a specified folder.
Source: awesome-copilot/prompts/update-markdown-file-index.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-update-markdown-file-index.
