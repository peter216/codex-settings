# ac-prompt-python-mcp-server-generator

Description: Generate a complete MCP server project in Python with tools, resources, and proper configuration
Source: awesome-copilot/prompts/python-mcp-server-generator.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-python-mcp-server-generator.
