# ac-prompt-java-springboot

Description: Get best practices for developing applications with Spring Boot.
Source: awesome-copilot/prompts/java-springboot.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-java-springboot.
