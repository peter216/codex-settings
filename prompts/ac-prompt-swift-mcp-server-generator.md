# ac-prompt-swift-mcp-server-generator

Description: Generate a complete Model Context Protocol server project in Swift using the official MCP Swift SDK package.
Source: awesome-copilot/prompts/swift-mcp-server-generator.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-swift-mcp-server-generator.
