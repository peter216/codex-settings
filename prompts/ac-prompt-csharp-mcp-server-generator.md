# ac-prompt-csharp-mcp-server-generator

Description: Generate a complete MCP server project in C# with tools, prompts, and proper configuration
Source: awesome-copilot/prompts/csharp-mcp-server-generator.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-csharp-mcp-server-generator.
