# ac-prompt-dotnet-design-pattern-review

Description: Review the C#/.NET code for design pattern implementation and suggest improvements.
Source: awesome-copilot/prompts/dotnet-design-pattern-review.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-dotnet-design-pattern-review.
