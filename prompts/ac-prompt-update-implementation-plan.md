# ac-prompt-update-implementation-plan

Description: Update an existing implementation plan file with new or update requirements to provide new features, refactoring existing code or upgrading packages, design, architecture or infrastructure.
Source: awesome-copilot/prompts/update-implementation-plan.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-update-implementation-plan.
