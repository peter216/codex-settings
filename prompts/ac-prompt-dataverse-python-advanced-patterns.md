# ac-prompt-dataverse-python-advanced-patterns
...
Source: awesome-copilot/prompts/dataverse-python-advanced-patterns.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-dataverse-python-advanced-patterns.
