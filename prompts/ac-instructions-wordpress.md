# ac-instructions-wordpress

Description: Coding, security, and testing rules for WordPress plugins and themes
Applies to: wp-content/plugins/**,wp-content/themes/**,**/*.php,**/*.inc,**/*.js,**/*.jsx,**/*.ts,**/*.tsx,**/*.css,**/*.scss,**/*.json
Source: awesome-copilot/instructions/wordpress.instructions.md
