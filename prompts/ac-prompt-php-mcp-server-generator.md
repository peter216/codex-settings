# ac-prompt-php-mcp-server-generator
...
Source: awesome-copilot/prompts/php-mcp-server-generator.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-php-mcp-server-generator.
