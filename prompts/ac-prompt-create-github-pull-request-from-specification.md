# ac-prompt-create-github-pull-request-from-specification

Description: Create GitHub Pull Request for feature request from specification file using pull_request_template.md template.
Source: awesome-copilot/prompts/create-github-pull-request-from-specification.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-create-github-pull-request-from-specification.
