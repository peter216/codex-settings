# ac-prompt-csharp-nunit

Description: Get best practices for NUnit unit testing, including data-driven tests
Source: awesome-copilot/prompts/csharp-nunit.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-csharp-nunit.
