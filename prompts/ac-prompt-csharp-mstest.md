# ac-prompt-csharp-mstest

Description: Get best practices for MSTest unit testing, including data-driven tests
Source: awesome-copilot/prompts/csharp-mstest.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-csharp-mstest.
