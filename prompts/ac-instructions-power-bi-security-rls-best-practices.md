# ac-instructions-power-bi-security-rls-best-practices
...
Applies to: **/*.{pbix,dax,md,txt,json,csharp,powershell}
Source: awesome-copilot/instructions/power-bi-security-rls-best-practices.instructions.md
