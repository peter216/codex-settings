# ac-prompt-dataverse-python-production-code
...
Source: awesome-copilot/prompts/dataverse-python-production-code.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-dataverse-python-production-code.
