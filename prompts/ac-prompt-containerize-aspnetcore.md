# ac-prompt-containerize-aspnetcore

Description: Containerize an ASP.NET Core project by creating Dockerfile and .dockerfile files customized for the project.
Source: awesome-copilot/prompts/containerize-aspnetcore.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-containerize-aspnetcore.
