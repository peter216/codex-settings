# ac-prompt-mkdocs-translations

Description: Generate a language translation for a mkdocs documentation stack.
Source: awesome-copilot/prompts/mkdocs-translations.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-mkdocs-translations.
