# ac-prompt-typescript-mcp-server-generator

Description: Generate a complete MCP server project in TypeScript with tools, resources, and proper configuration
Source: awesome-copilot/prompts/typescript-mcp-server-generator.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-typescript-mcp-server-generator.
