# ac-instructions-power-bi-custom-visuals-development
...
Applies to: **/*.{ts,tsx,js,jsx,json,less,css}
Source: awesome-copilot/instructions/power-bi-custom-visuals-development.instructions.md
