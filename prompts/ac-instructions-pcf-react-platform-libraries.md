# ac-instructions-pcf-react-platform-libraries

Description: React controls and platform libraries for PCF components
Applies to: **/*.{ts,tsx,js,json,xml,pcfproj,csproj}
Source: awesome-copilot/instructions/pcf-react-platform-libraries.instructions.md
