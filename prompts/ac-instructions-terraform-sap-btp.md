# ac-instructions-terraform-sap-btp

Description: Terraform conventions and guidelines for SAP Business Technology Platform (SAP BTP).
Applies to: **/*.tf, **/*.tfvars, **/*.tflint.hcl, **/*.tf.json, **/*.tfvars.json
Source: awesome-copilot/instructions/terraform-sap-btp.instructions.md
