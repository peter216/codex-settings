# ac-prompt-my-pull-requests

Description: List my pull requests in the current repository
Source: awesome-copilot/prompts/my-pull-requests.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-my-pull-requests.
