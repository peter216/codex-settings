# ac-prompt-finalize-agent-prompt

Description: Finalize prompt file using the role of an AI agent to polish the prompt for the end user.
Source: awesome-copilot/prompts/finalize-agent-prompt.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-finalize-agent-prompt.
