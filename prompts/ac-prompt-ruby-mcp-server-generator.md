# ac-prompt-ruby-mcp-server-generator

Description: Generate a complete Model Context Protocol server project in Ruby using the official MCP Ruby SDK gem.
Source: awesome-copilot/prompts/ruby-mcp-server-generator.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-ruby-mcp-server-generator.
