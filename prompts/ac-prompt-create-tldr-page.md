# ac-prompt-create-tldr-page

Description: Create a tldr page from documentation URLs and command examples, requiring both URL and command name.
Source: awesome-copilot/prompts/create-tldr-page.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-create-tldr-page.
