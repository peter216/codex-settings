# ac-prompt-java-mcp-server-generator
...
Source: awesome-copilot/prompts/java-mcp-server-generator.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-java-mcp-server-generator.
