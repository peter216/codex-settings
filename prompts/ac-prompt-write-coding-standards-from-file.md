# ac-prompt-write-coding-standards-from-file
...
Source: awesome-copilot/prompts/write-coding-standards-from-file.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-write-coding-standards-from-file.
