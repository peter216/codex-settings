# ac-prompt-breakdown-feature-prd

Description: Prompt for creating Product Requirements Documents (PRDs) for new features, based on an Epic.
Source: awesome-copilot/prompts/breakdown-feature-prd.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-breakdown-feature-prd.
