# ac-prompt-create-spring-boot-kotlin-project

Description: Create Spring Boot Kotlin Project Skeleton
Source: awesome-copilot/prompts/create-spring-boot-kotlin-project.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-create-spring-boot-kotlin-project.
