# ac-prompt-shuffle-json-data

Description: Shuffle repetitive JSON objects safely by validating schema consistency before randomising entries.
Source: awesome-copilot/prompts/shuffle-json-data.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-shuffle-json-data.
