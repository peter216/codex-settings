# ac-prompt-rust-mcp-server-generator
...
Source: awesome-copilot/prompts/rust-mcp-server-generator.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-rust-mcp-server-generator.
