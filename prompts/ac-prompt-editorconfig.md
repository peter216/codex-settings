# ac-prompt-editorconfig

Description: Generates a comprehensive and best-practice-oriented .editorconfig file based on project analysis and user preferences.
Source: awesome-copilot/prompts/editorconfig.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-editorconfig.
