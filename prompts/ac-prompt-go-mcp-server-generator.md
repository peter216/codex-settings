# ac-prompt-go-mcp-server-generator
...
Source: awesome-copilot/prompts/go-mcp-server-generator.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-go-mcp-server-generator.
