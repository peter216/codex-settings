# ac-prompt-playwright-automation-fill-in-form

Description: Automate filling in a form using Playwright MCP
Source: awesome-copilot/prompts/playwright-automation-fill-in-form.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-playwright-automation-fill-in-form.
