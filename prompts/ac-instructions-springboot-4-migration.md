# ac-instructions-springboot-4-migration
...
Applies to: **/*.java, **/*.kt, **/build.gradle.kts, **/build.gradle, **/settings.gradle.kts, **/gradle/libs.versions.toml, **/*.properties, **/*.yml, **/*.yaml
Source: awesome-copilot/instructions/springboot-4-migration.instructions.md
