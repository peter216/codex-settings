# ac-instructions-power-platform-mcp-development
...
Applies to: **/*.{json,csx,md}
Source: awesome-copilot/instructions/power-platform-mcp-development.instructions.md
