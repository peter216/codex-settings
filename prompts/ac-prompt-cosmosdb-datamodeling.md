# ac-prompt-cosmosdb-datamodeling
...
Source: awesome-copilot/prompts/cosmosdb-datamodeling.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-cosmosdb-datamodeling.
