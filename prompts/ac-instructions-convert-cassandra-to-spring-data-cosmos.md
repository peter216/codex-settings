# ac-instructions-convert-cassandra-to-spring-data-cosmos
...
Applies to: **/*.java,**/pom.xml,**/build.gradle,**/application*.properties,**/application*.yml,**/application*.conf
Source: awesome-copilot/instructions/convert-cassandra-to-spring-data-cosmos.instructions.md
