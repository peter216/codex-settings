# ac-prompt-convert-plaintext-to-md
...
Source: awesome-copilot/prompts/convert-plaintext-to-md.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-convert-plaintext-to-md.
