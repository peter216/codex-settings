# ac-instructions-kotlin-mcp-server
...
Applies to: **/*.kt, **/*.kts, **/build.gradle.kts, **/settings.gradle.kts
Source: awesome-copilot/instructions/kotlin-mcp-server.instructions.md
