# ac-instructions-power-apps-code-apps
...
Applies to: **/*.{ts,tsx,js,jsx}, **/vite.config.*, **/package.json, **/tsconfig.json, **/power.config.json
Source: awesome-copilot/instructions/power-apps-code-apps.instructions.md
