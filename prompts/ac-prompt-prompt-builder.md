# ac-prompt-prompt-builder

Description: Guide users through creating high-quality GitHub Copilot prompts with proper structure, tools, and best practices.
Source: awesome-copilot/prompts/prompt-builder.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-prompt-builder.
