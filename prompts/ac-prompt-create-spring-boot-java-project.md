# ac-prompt-create-spring-boot-java-project

Description: Create Spring Boot Java Project Skeleton
Source: awesome-copilot/prompts/create-spring-boot-java-project.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-create-spring-boot-java-project.
