# ac-prompt-add-educational-comments

Description: Add educational comments to the file specified, or prompt asking for file to comment if one is not provided.
Source: awesome-copilot/prompts/add-educational-comments.prompt.md

Codex note: Converted from a GitHub Copilot prompt. Invoke with /prompts:ac-prompt-add-educational-comments.
